...
class WalkingState:
    ...
    def do(boy):
        ...
        boy.x = clamp(0 , boy.x, (boy.y+175)*6.125)
...
class Boy:
    ...
    def get_bb(self):
        return self.x - 50 - self.bg.window_left, self.y - 50 - self.bg.window_bottom, \
               self.x + 50 - self.bg.window_left, self.y + 50 - self.bg.window_bottom
